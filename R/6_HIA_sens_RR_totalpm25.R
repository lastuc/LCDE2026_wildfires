...
attr_nuts <- bind_rows(hia03[[1]], hia04[[1]], hia05[[1]], hia06[[1]], hia07[[1]],
                       ...
                       hia23[[1]], hia24[[1]])
write_csv(attr_nuts, paste0(pathroot, "data/processed/attributable_nuts_sens_RR_totalpm25.csv"))
...
attr_country <- bind_rows(hia03[[2]], hia04[[2]], hia05[[2]], hia06[[2]], hia07[[2]],
                          ...
                          hia23[[2]], hia24[[2]])
write_csv(attr_country, paste0(pathroot, "data/processed/attributable_country_sens_RR_totalpm25.csv"))
...
attributable_region <- bind_rows(hia03[[3]], hia04[[3]], hia05[[3]], hia06[[3]], hia07[[3]],
                                 ...
                                 hia23[[3]], 
                                 hia24[[3]])
write_csv(attributable_region, paste0(pathroot, "data/processed/attributable_region_sens_RR_totalpm25.csv"))
...
attr_eu <- bind_rows(hia03[[4]], hia04[[4]], hia05[[4]], hia06[[4]], hia07[[4]],
                     ...
                     hia23[[4]], hia24[[4]])
write_csv(attr_eu, paste0(pathroot, "data/processed/attributable_eu_sens_RR_totalpm25.csv"))
