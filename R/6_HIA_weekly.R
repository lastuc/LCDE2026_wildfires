#-----------------------------------------------------------------------------#
#              Population-weighted exposures, weekly RR and PAFs              #
#-----------------------------------------------------------------------------#
...
# 1. Weekly RR by Anna Alari ----

# lag0: 1.011263 (95% CI 1.010151-1.012376) per 1ug/m3 increment increase
set.seed(1234)
point_RR10 <- 1.011263^10
nsim <- 200
sim_RR10 <- exp(rnorm(nsim, mean = log(point_RR10), sd = log((1.012376^10)/(1.010151^10))/(qnorm(0.975)*2)))
names(sim_RR10) <- paste0("RR10_", str_pad(1:nsim, 3, "left", "0"))


# 2. Mortality ----

mortality <- fread(paste0(pathroot, "data/processed/mortality_weekly.csv"))
...
hia03 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2003.csv"))
hia04 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2004.csv"))
hia05 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2005.csv"))
hia06 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2006.csv"))
hia07 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2007.csv"))
hia08 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2008.csv"))
hia09 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2009.csv"))
hia10 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2010.csv"))
hia11 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2011.csv"))
hia12 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2012.csv"))
hia13 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2013.csv"))
hia14 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2014.csv"))
hia15 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2015.csv"))
hia16 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2016.csv"))
hia17 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2017.csv"))
hia18 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2018.csv"))
hia19 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2019.csv"))
hia20 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2020.csv"))
hia21 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2021.csv"))
hia22 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2022.csv"))
hia23 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2023.csv"))
hia24 <- hia(paste0(pathroot, "data/processed/assembled/data_weekly_2024.csv"))
...
attr_nuts <- bind_rows(hia03[[1]], hia04[[1]], hia05[[1]], hia06[[1]], hia07[[1]],
                       ...
                       hia23[[1]], hia24[[1]])
write_csv(attr_nuts, paste0(pathroot, "data/processed/attributable_nuts_weekly.csv"))
...
attr_country <- bind_rows(hia03[[2]], hia04[[2]], hia05[[2]], hia06[[2]], hia07[[2]],
                          ...
                          hia23[[2]], hia24[[2]])
write_csv(attr_country, paste0(pathroot, "data/processed/attributable_country_weekly.csv"))
...
attributable_region <- bind_rows(hia03[[3]], hia04[[3]], hia05[[3]], hia06[[3]], hia07[[3]],
                                 ...
                                 hia23[[3]], hia24[[3]])
write_csv(attributable_region, paste0(pathroot, "data/processed/attributable_region_weekly.csv"))
...
attr_eu <- bind_rows(hia03[[4]], hia04[[4]], hia05[[4]], hia06[[4]], hia07[[4]],
                     ...
                     hia23[[4]], hia24[[4]])
write_csv(attr_eu, paste0(pathroot, "data/processed/attributable_eu_weekly.csv"))
...
attr_euro <- bind_rows(hia03[[5]], hia04[[5]], hia05[[5]], hia06[[5]], hia07[[5]],
                       ...
                       hia23[[5]], hia24[[5]])
write_csv(attr_euro, paste0(pathroot, "data/processed/attributable_euro_weekly.csv"))
